...
Hi! I'm a Pre-Doctoral Research Fellow at Microsoft Research India (MSRI), advised by <a href = 'https://www.microsoft.com/en-us/research/people/satya/'>Satya Lokam</a>. My work focuses on the information-theoretic interpretations of privacy in machine learning and query-complexity lower bounds in adaptive auditing strategies for private learners. More recently, I've been working with <a href='https://sinhagaurav.github.io/'> Gaurav Sinha </a> on the problem of identifying best interventions in causal bandits.

In the past, I've collaborated with Microsoft product teams on confidential computing for <a href = 'https://github.com/Sahamati/fiu-data-governance'>Trustworthy Data Governance</a>. Prior to MSRI, I was an intern at Amazon in the Payments division, and an Undergraduate Researcher at Aalto University, Finland, where I worked on blockchain and applied cryptography.
